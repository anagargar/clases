...
class Models_applicationModel
{
	...
	public function renderView($config, $view, array $params)
	{
	...
	public function renderLayout($config, $layout, array $params)
	{
	...
	static public function acl($arrayRequest, $config)
	{	
		...
		$sql="SELECT resource 
				...
				WHERE roles_has_resources.roles_idrol=".$_SESSION[$config['sessionNamespace']]['user_rol'];
